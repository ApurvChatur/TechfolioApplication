        ...
        <div className="container px-5 py-24 mx-auto flex flex-wrap flex-col">
          ...
          {Redux.state.ReceivedObject?.Retrieve?.BranchRetrieve?.subBranches?.map((each, index) => (
            <React.Fragment key={index}>
              <div className={`flex flex-wrap text-center bg-[#2D2926] dark:bg-[#ed6f63] text-[#ed6f63] dark:text-[#2D2926] bg-opacity-60 px-4 py-6 rounded-lg ${activeBranchGroup === each.title ? "" : "hidden"}`}>
