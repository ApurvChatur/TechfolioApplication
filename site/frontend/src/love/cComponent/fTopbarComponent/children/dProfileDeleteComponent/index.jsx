...
const ProfileDeleteComponent = ({ Redux, OnClick }) => {
  ...
  return (
    <React.Fragment>
      <section class="bg-[#DBB98F] dark:bg-[#96351F] text-[#96351F] dark:text-[#DBB98F] lg:px-20">
            ...
            <div class="flex flex-col sm:flex-row mt-10">
              <div class="sm:w-1/3 text-center sm:pr-8 sm:py-8">
                ...
                <div class="flex flex-col items-center text-center justify-center">
                  ...
                  <div class="w-12 h-1 bg-[#96351F] dark:bg-[#DBB98F] rounded mt-2 mb-4"></div>
          ...
          <div class="flex flex-wrap -m-4 justify-center">
            <div class="p-4 lg:w-4/6">
              <div class="h-full p-6 rounded-lg border border-[#96351F] dark:border-[#DBB98F] flex flex-col relative overflow-hidden">
                <h1 class="text-md pb-4 mb-4 border-b border-[#96351F] dark:border-[#DBB98F] leading-none">Are you sure! You want to delete your account?</h1>
